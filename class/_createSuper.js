 ...
 function createSuper(Derived){
  ...
  function _super(){
    if(this instanceof Derived){ //혹시 모르지만, 클래스 영역 밖에서 쓰였거나 call로 인스턴스를 넣지 않았을 경우를 대비.
      const material = {}; //Super에서 _classCallCheck에 안 걸리도록...
      material.__proto__ = Super.prototype; //super 인스턴스 빈 거 하나 만들어 주고
      Object.assign(this, Super.apply(material, arguments)); //실질 속성만 취하기.
    } else {
